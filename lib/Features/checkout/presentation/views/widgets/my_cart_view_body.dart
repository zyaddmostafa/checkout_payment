import 'package:checkout_payment_ui/Features/checkout/data/repo/checkout_repo_iml.dart';
...
import 'package:checkout_payment_ui/Features/checkout/presentation/views/widgets/payment_method_bottom_sheet.dart';
          ...
          CustomButton(
            ...
            onTap: () {
              ...
              showModalBottomSheet(
                  ...
                  builder: (context) {
                    return BlocProvider(
                      create: (context) => PaymentCubit(CheckoutRepoIml()),
